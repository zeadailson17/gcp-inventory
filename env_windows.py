...
def filter_instances(input_file, output_file):
    ...
    with open(input_file, 'r', newline='') as csvfile:
        ...
        with open(output_file, 'w') as txtfile:
            ...
            for row in reader:
                # Check if Instance OS is Windows and Instance Status is RUNNING
                if 'windows' in row['Instance OS'].lower() and row['Instance Status'] == 'RUNNING':
...
if __name__ == "__main__":
    ...
    output_file = 'env/dev/windows.txt'  # Change to your output file name
